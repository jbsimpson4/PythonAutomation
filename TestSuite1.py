...
search_text = unittest.TestLoader().loadTestsFromTestCase(SearchText.SearchText)
home_page_test = unittest.TestLoader().loadTestsFromTestCase(HomePageTest.HomePageTest)
